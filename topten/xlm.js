/*global today*/
// RETREIVING XRP DATA
document.getElementById('xlmDaily').addEventListener('click', loadXlmDaily);

// Load Daily Bitcoin Data
function loadXlmDaily() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=XLM&market=USD&apikey=JCQV2KWHYVU535I7', true);
