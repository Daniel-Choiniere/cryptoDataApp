/*global today*/
// RETREIVING LTC DATA
document.getElementById('ltcDaily').addEventListener('click', loadLtcDaily);

// Load Daily Bitcoin Data
function loadLtcDaily() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=LTC&market=USD&apikey=JCQV2KWHYVU535I7', true);
