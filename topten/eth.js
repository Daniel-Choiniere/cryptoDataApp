/*global today*/
// RETREIVING ETH DATA
document.getElementById('ethDaily').addEventListener('click', loadEthDaily);

// Load Daily Bitcoin Data
function loadEthDaily() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=ETH&market=USD&apikey=JCQV2KWHYVU535I7', true);
