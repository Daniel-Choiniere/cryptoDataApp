/*global today*/
// RETREIVING XRP DATA
document.getElementById('trxDaily').addEventListener('click', loadTrxDaily);

// Load Daily Bitcoin Data
function loadTrxDaily() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=TRX&market=USD&apikey=JCQV2KWHYVU535I7', true);
