/*global today*/
// RETREIVING XRP DATA
document.getElementById('bnbDaily').addEventListener('click', loadBnbDaily);

// Load Daily Bitcoin Data
function loadBnbDaily() {
    var xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://www.alphavantage.co/query?function=DIGITAL_CURRENCY_DAILY&symbol=BNB&market=USD&apikey=JCQV2KWHYVU535I7', true);
